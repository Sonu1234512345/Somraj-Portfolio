      ...
      <div className="border-t border-softGray overflow-hidden">
        <div className="container relative z-10">
          ...
          <div className="relative z-10 py-16 md:py-32">
            ...
            <div className="flex flex-wrap flex-col lg:flex-row gap-10 xl:gap-20">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-5 xl:gap-7 w-full">
