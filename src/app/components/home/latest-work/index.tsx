                  ...
                  >
                    <div className="relative h-[300px] group">
                      <Image
                        ...
                        width={570}
                        height={414}
                        className="rounded-lg w-full h-full object-cover object-top group-hover:object-bottom transition-all duration-700"
                      />
                      <Link
                        href={value?.href || "#"}
                        target="_blank"
                    ...
                    <div className="flex flex-col gap-0 xl:gap-2">
                      ...
                      <div className="flex flex-col gap-0 gap-2 md:flex-row mt-2.5 justify-between">
                      <p><span>Type:</span> {value?.type}</p>
